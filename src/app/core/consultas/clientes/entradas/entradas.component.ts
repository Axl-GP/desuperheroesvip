...
export class EntradasComponent implements OnInit {
  ...
  capturar(){
    ...
    .then(function (dataUrl){
      ...
      pdf.addImage(dataUrl,'png',0,0,18.,18.0);
  ...
  decision(){
    ...
    }else if(this.busqueda.value==this.productos.producto){
    ...
    }else if(this.busqueda==this.productos.fechaImporte){
      if(filtrado=="suma"){
